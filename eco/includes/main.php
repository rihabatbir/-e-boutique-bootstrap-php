...
<header>
    <div class="profile">
            <div class="logo-lg">
                <a href="./index.php#banniere" class="logo"><span>BR</span>cos</a><!--on doit placer le logo-->
            </div>
            <?php
                if(!isset($_SESSION['customer_email'])){
                    ...
                    { 
                        echo '<a href="customer/my_account.php?my_orders"><button class="btn btn-primary">Compte</button class="btn btn-primary"></a>';
                    }   
                    ?> 
                    <?php
                        if(!isset($_SESSION['customer_email'])){
                        echo '<a href="customer/customer_login.php"><button class="btn btn-primary">Se connecter</button></a>'; //checkout.php!!
                        } 
                        else
                        { 
